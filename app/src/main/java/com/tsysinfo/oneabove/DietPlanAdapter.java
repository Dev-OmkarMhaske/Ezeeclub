...
public class DietPlanAdapter  extends BaseAdapter {
    ...
    private static ArrayList<DietPlan> searchArrayList;
    private LayoutInflater mInflater;
    Calendar calendar;
    Context context;
    DataBaseAdapter dba;
    public DietPlanAdapter(Context context, ArrayList<DietPlan> results) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        DietPlanAdapter.ViewHolder holder = null;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.diet_plan_row, null);
            holder = new DietPlanAdapter.ViewHolder();
        ...
        holder.text.setText(searchArrayList.get(position).getFromDate());
        holder.textplan.setText(searchArrayList.get(position).getToDate());
        ...
        holder.root_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(context,DietRemark.class);
