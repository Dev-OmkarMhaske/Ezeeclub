...
public class SocialActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fac=(ImageView)findViewById(R.id.facebook);
        ista=(ImageView)findViewById(R.id.instagram);
        ...
        plan();
         fac.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 Uri uri = Uri.parse("https://www.facebook.com/tsysinfotechnologies/"); // missing 'http://' will cause crashed
        ...
        ista.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://www.instagram.com/tsysinfotechnologies/"); // missing 'http://' will cause crashed
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
        ...
        twi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri uri = Uri.parse("https://twitter.com/TsysinfoL/"); // missing 'http://' will cause crashed
                Intent intent = new Intent(Intent.ACTION_VIEW, uri);
                startActivity(intent);
            }
        });
    ...
    public void plan()
    {
        ...
        Webutil.getResponse(SocialActivity.this , SharedPreferenceUtil.getLoginUrl(getApplicationContext())+"GetPlanDetails" , param.toString() , new MyHand());
    }
